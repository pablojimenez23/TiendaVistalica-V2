  ...
  return (
    <section className="py-5">
      <div className="container text-center">
        ...
        <p className="text-muted">Recibe novedades, descuentos y colecciones exclusivas.</p>
        <form id="boletinForm" className="row justify-content-center" onSubmit={validar}>
